...
/*
 * ћетод обнаружени€ устройства и синхронизации его с портом
 */
bool DS9097::Detect()
{
	if( !port->isOpened() )
...
/*
 * ”становить скорость передачи данных на соответствующее количество бит/с
 */
bool DS9097::setSpeed( ComPort::eSpeed newSpeed)
{
	...
	command[0] = READ_SPEED_COMMAND; // команда чтени€ скорости
...
{
	commandLen = 0;
	// смотрим режим и добовл€ем переход в режим команд, если надо
...
/*
 * ћетод записи байта в сеть 1-Wire
 */
...
/*
 * ћетод отправки бита в сеть 1-Wire
 */
